...
int main(int, char**) {
    ...
    std::cout << "fromENU_WGS84.latitude = " << local_to_geo.latitude()
              << std::endl;
    std::cout << "fromENU_WGS84.longitude = " << local_to_geo.longitude()
              << std::endl;
    std::cout << "fromENU_WGS84.altitude = " << local_to_geo.altitude()
              << std::endl;

...
set "App=%ProductsDir%\experiments\cpp\kitti-runner\%Config%\kitti-runner.exe"
...
set ImagesDir=Z:/C/data/data_odometry_gray/dataset/sequences/05/image_0
set SensorSource=Z:/C/data/gt/data_odometry_poses/dataset/poses/05.txt
...
REM set ImagesDir=Z:/C/data/data_odometry_gray/dataset/sequences/07/image_0
REM set SensorSource=Z:/C/data/gt/data_odometry_poses/dataset/poses/07.txt
...
%App% %Option% %Vocabulary% %Settings% %ImagesDir% %SensorSource% %Output%

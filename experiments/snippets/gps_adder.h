...
public:
    ...
    void add_gps_to_pose_optimization(
        g2o::VertexSE3Expmap*,
        pos_info_opt_t
    );
    void add_gps_to_ba_for_local_kf(
        g2o::VertexSE3Expmap*,
        pos_info_opt_t
    );
    void add_gps_to_ba_for_fixed_kf(
        g2o::VertexSE3Expmap*,
        pos_info_opt_t
    );
...
private:
    ...
    void add_gps(g2o::VertexSE3Expmap*, g2o::VertexSE3Expmap*,
        pos_info_opt_t&, pos_info_opt_t&);
    Eigen::Vector3d to_local(pos_info_opt_t&);
    double distance(pos_info_opt_t&, pos_info_opt_t&);
    Eigen::Matrix<double, 1, 1> calculate_inf_of_dist_edge(
        pos_info_opt_t&, pos_info_opt_t&);
    Eigen::Vector3d rotate(const Eigen::Vector3d& point, const ext::orientation_t& rot);
